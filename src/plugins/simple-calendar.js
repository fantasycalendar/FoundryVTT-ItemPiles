...
export default class SimpleCalendarPlugin extends BasePlugin {
	...
	async handleTimePassed() {
		...
		await this.hideMerchantTokens();
		await this.refreshMerchantInventories(newState, previousState, categories);
	...
	async refreshMerchantInventories(newState, previousState, categories) {
